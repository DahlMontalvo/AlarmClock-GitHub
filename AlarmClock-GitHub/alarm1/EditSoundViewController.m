...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if ([[[Singleton sharedSingleton] sharedPrefs] integerForKey:@"editAlarmSoundType"] == 0) {
            [cell setAccessoryType:UITableViewCellAccessoryCheckmark];
        }
    }
    else {
        cell.textLabel.text = [[soundArray objectAtIndex:indexPath.row] objectAtIndex:0];
        if ([[[Singleton sharedSingleton] sharedPrefs] integerForKey:@"editAlarmSoundType"] == 1 && [[[soundArray objectAtIndex:indexPath.row] objectAtIndex:0] isEqualToString:[[[[Singleton sharedSingleton] sharedPrefs] valueForKey:@"editAlarmSoundInfo"] objectAtIndex:0]]) {
            [cell setAccessoryType:UITableViewCellAccessoryCheckmark];
        }
    }
...
- (void) mediaPicker: (MPMediaPickerController *) mediaPicker didPickMediaItems: (MPMediaItemCollection *) mediaItemCollection
{
    if (mediaItemCollection) {
        ...
        [[[Singleton sharedSingleton] sharedPrefs] setValue:item forKey:@"editAlarmSoundItem"];
        [[[Singleton sharedSingleton] sharedPrefs] setInteger:0 forKey:@"editAlarmSoundType"];
        [[[Singleton sharedSingleton] sharedPrefs] setValue:nil forKey:@"editAlarmSoundInfo"];
        ...
        [[[Singleton sharedSingleton] sharedPrefs] setValue:nil forKey:@"editAlarmSoundItem"];
        [[[Singleton sharedSingleton] sharedPrefs] setValue:nil forKey:@"editAlarmSoundType"];
        [[[Singleton sharedSingleton] sharedPrefs] setValue:nil forKey:@"editAlarmSoundInfo"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        [[[Singleton sharedSingleton] sharedPrefs] setValue:nil forKey:@"editAlarmSoundItem"];
        [[[Singleton sharedSingleton] sharedPrefs] setInteger:1 forKey:@"editAlarmSoundType"];
        [[[Singleton sharedSingleton] sharedPrefs] setValue:[soundArray objectAtIndex:indexPath.row] forKey:@"editAlarmSoundInfo"];
    }
